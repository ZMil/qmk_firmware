...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_CAPS, FN_1,   KC_A   , KC_S   , KC_D   , KC_F   , KC_G  ,                                            KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_UNDS,
                 KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_MUTE, KC_MUTE, /**/  KC_RBRC, KC_RBRC, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                                           _______, KC_LALT, KC_LGUI, KC_LCTL, KC_SPC, /**/ KC_ENT, FN_2  , KC_BSPC, KC_RGUI, _______
    ),
    [_LOWER] = LAYOUT(
                 _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                                           KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,
                 KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                                          KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC,                                           KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, _______,
                 _______, KC_EQL , KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______, _______, /**/  _______, _______,  _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                                            _______, _______, _______, _______, _______, /**/  _______, _______, _______, _______, _______
    ),
    [_RAISE] = LAYOUT(
                 _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                                           KC_VOLD, KC_VOLU, KC_MUTE, _______, _______ , _______ ,
                 _______, KC_0   , KC_1   , KC_2   , KC_3   , KC_BSPC,                                           KC_PGUP, _______, _______, _______, _______ , _______ ,
        _______, _______, KC_0   , KC_4   , KC_5   , KC_6   , KC_DEL ,                                           _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT , _______ , _______,
                 _______, KC_0   , KC_7   , KC_8   , KC_9   , KC_DOT , _______, _______, /**/  _______, _______, KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                                            _______, _______, _______, _______, _______, /**/  _______, _______, _______, _______, _______
    ),
};
